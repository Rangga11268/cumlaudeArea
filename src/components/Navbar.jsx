...
const Navbar = ({ activeTab, setView, theme, toggleTheme, isCustomSession }) => (
  <header className="navbar glass-panel">
    ...
    <div className="nav-center">
      ...
      <button className={`nav-btn ${activeTab === 'calculator' ? 'active' : ''}`} onClick={() => setView('calculator')}>Kalkulator MPSI</button>
